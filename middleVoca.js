var middleVoca = (function(){
    ...
    $(document).ready(function() {
        ...
        const longestText = word.reduce((longest, current) =>
    ...
    async function searchWord(wordStr) {
        document.getElementById("meaningBox").innerHTML = `<p>🔍 단어를 찾는 중...</p>`;
        const word = wordStr;
